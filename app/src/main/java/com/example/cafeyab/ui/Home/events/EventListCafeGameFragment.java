 ...
 */
public class EventListCafeGameFragment extends Fragment {
    ...
    public EventListCafeGameFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_event_list_cafe_game, container, false);
        eventimage=view.findViewById(R.id.eventimage_eventlistcafegame);
        title=view.findViewById(R.id.title_eventlistcafegame);


        Bundle bundle=this.getArguments();
        String idstr=bundle.getString("id");
        String imgurl=bundle.getString("imageurl");
        String category_event=bundle.getString("event_category");

        if (category_event.equals("2") ){
            title.setText("Game Information : ");
        }

        if (category_event.equals("3") ){
            title.setText("Concert Information : ");
        }

        if (category_event.equals("4") ){
            title.setText("WorkShop Information : ");
        }
...
//        date.setText(datestr);
        ...
        recyclerView_eventlistcafe=view.findViewById(R.id.recylerview_eventlistcafegame);
