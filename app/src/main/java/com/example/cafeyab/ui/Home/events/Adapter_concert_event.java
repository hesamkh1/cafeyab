...
public class Adapter_concert_event extends RecyclerView.Adapter<Adapter_concert_event.MyViewHolder>  {

    private List<Event> events;
    private Context context;
    private FragmentManager fragmentManager;

    public Adapter_concert_event(List<Event> events, Context context, FragmentManager fragmentManager) {
        this.events = events;
    ...
    @NonNull
    @Override
    public Adapter_concert_event.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_for_concert_event, parent, false);
        return new Adapter_concert_event.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_concert_event.MyViewHolder holder, final int position) {
    ...
    public static class  MyViewHolder extends RecyclerView.ViewHolder{
        ...
        {
            super(itemView);
            img=itemView.findViewById(R.id.image_concertevent);
            time=itemView.findViewById(R.id.time_concertevent);
            date=itemView.findViewById(R.id.date_concertevent);
            name=itemView.findViewById(R.id.name_concertevent);
            parentLayout=itemView.findViewById(R.id.parent_layout_concertevent);
